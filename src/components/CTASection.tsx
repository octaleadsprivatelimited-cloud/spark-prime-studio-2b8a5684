      ...
      <div className="mx-auto max-w-4xl px-4 py-10 text-center sm:py-14 lg:px-6 lg:py-20">
        <SectionReveal>
          ...
          <div className="mt-6 flex flex-wrap items-center justify-center gap-3 sm:mt-8 sm:gap-4">
            ...
            <a href={`tel:${settings.phone.replace(/\s+/g, "")}`} className="inline-flex items-center gap-2 whitespace-nowrap rounded border border-current/20 px-5 py-2.5 text-xs font-semibold opacity-80 transition-opacity hover:opacity-100 sm:px-6 sm:py-3 sm:text-sm">
