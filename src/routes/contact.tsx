        ...
        <div className="relative mx-auto max-w-7xl px-4 py-14 sm:py-20 lg:px-6 lg:py-28">
          <SectionReveal>
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <a href={`tel:${settings.phone.replace(/\s+/g, "")}`} className="btn-primary">Call {settings.phone}</a>
              <a href={`https://wa.me/${settings.whatsappNumber}`} target="_blank" rel="noopener noreferrer" className="btn-yellow">WhatsApp Chat</a>
            </div>
          </SectionReveal>
        </div>
      </section>
                ...
                <div className="space-y-5">
                  ...
                  <div className="rounded-lg border border-border bg-card p-6 shadow-sm">
                    ...
                    <div className="mt-3 space-y-3">
                      <a href={`tel:${settings.phone.replace(/\s+/g, "")}`} className="flex items-center gap-3 text-sm text-muted-foreground hover:text-foreground">
                      ...
                      <a href={`mailto:${settings.email}`} className="flex items-center gap-3 text-sm text-muted-foreground hover:text-foreground">
                        <span className="flex h-9 w-9 items-center justify-center rounded bg-brand-red/10 text-brand-red">
                      ...
                      <a href={`https://wa.me/${settings.whatsappNumber}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-sm text-muted-foreground hover:text-foreground">
                        <span className="flex h-9 w-9 items-center justify-center rounded bg-brand-red/10 text-brand-red">
                  ...
                  <div className="rounded-lg border border-border bg-card p-6 shadow-sm">
                    ...
                    <div className="mt-3 space-y-2 text-sm text-muted-foreground">
                      <div className="flex justify-between gap-4"><span>Reg. Number</span><span className="font-semibold text-foreground text-right">{settings.regNumber}</span></div>
                      <div className="flex justify-between gap-4"><span>GST Number</span><span className="font-semibold text-foreground text-right">{settings.gstNumber}</span></div>
