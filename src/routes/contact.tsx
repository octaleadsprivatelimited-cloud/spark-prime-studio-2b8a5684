...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Get in touch with Nataraj Electricals for electrical contracting services in Bangalore. Request a free quote today." },
      { property: "og:title", content: "Contact Us — Nataraj Electricals" },
      { property: "og:description", content: "Contact us for a free consultation and project estimate. Available 24/7." },
    ],
  }),
    ...
    <>
      <section className="hero-gradient section-padding">
        <div className="mx-auto max-w-7xl px-4 md:px-6">
          <SectionReveal>
            <span className="text-xs font-semibold uppercase tracking-widest text-primary-foreground/60">Contact Us</span>
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-6">
                    ...
                    <form onSubmit={handleSubmit} className="mt-6 space-y-5">
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full resize-none rounded-xl border border-input bg-background px-4 py-3 text-sm text-foreground outline-none transition-colors focus:border-ring focus:ring-2 focus:ring-ring/20"
                          placeholder="Tell us about your project..."
                        />
                      </div>
                      <button type="submit" className="btn-gradient w-full rounded-xl py-3.5 text-sm font-semibold">
                        Send Message
                      </button>
                    </form>
                  )}
                ...
                <div className="space-y-6">
                  ...
                  <div className="rounded-2xl border border-border bg-card p-6">
                    ...
                    <div className="mt-3 space-y-3">
                      <a href="tel:+919876543210" className="flex items-center gap-3 text-sm text-muted-foreground hover:text-foreground">
                        <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-primary/10 text-primary">
                          <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
                        </div>
                        +91 98765 43210
                      </a>
                      <a href="mailto:info@natarajelectricals.com" className="flex items-center gap-3 text-sm text-muted-foreground hover:text-foreground">
                        <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-primary/10 text-primary">
          ...
          <SectionReveal>
            <div className="mt-12 overflow-hidden rounded-2xl border border-border">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3887.1!2d77.5!3d13.03!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMTPCsDAyJzI0LjAiTiA3N8KwMzAnMDAuMCJF!5e0!3m2!1sen!2sin!4v1"
                width="100%"
                height="350"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="Nataraj Electricals Office Location"
              />
            </div>
          </SectionReveal>
        </div>
