              ...
              <SectionReveal delay={0.1}>
                <div className="space-y-5">
                  <div className="rounded border border-border bg-card p-6">
                    ...
                    <p className="mt-2 text-sm text-muted-foreground">#123, Industrial Layout,<br />Peenya, Bangalore - 560058,<br />Karnataka, India</p>
                  </div>
                  <div className="rounded border border-border bg-card p-6">
                    ...
                    <div className="mt-3 space-y-3">
                      ...
                      <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-sm text-muted-foreground hover:text-foreground">
                        <span className="flex h-9 w-9 items-center justify-center rounded bg-brand-red/10 text-brand-red">
