...
function HomePage() {
  ...
  return (
    <>
      ...
      {/* Blue & White Gradient Banner */}
      <section className="relative overflow-hidden bg-gradient-to-b from-accent to-background">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,oklch(0.55_0.20_255/0.15),transparent_50%)]" />
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,oklch(0.55_0.20_255/0.08),transparent_50%)]" />
        <div className="relative mx-auto max-w-7xl px-4 py-10 sm:py-14 lg:px-6 lg:py-20">
          <div className="grid items-center gap-8 lg:grid-cols-2 lg:gap-14">
            <SectionReveal>
              <div>
                <span className="inline-flex items-center gap-2 rounded-full bg-background/80 px-3 py-1 text-[11px] font-bold uppercase tracking-widest text-accent backdrop-blur-sm sm:text-xs">
                ...
                <h2 className="mt-4 font-heading text-3xl font-extrabold leading-tight text-background sm:text-4xl lg:text-[2.75rem]">
                  Powering India's Infrastructure with Precision & Safety
                </h2>
                <p className="mt-4 max-w-lg text-sm leading-relaxed text-background/80 sm:text-base">
                  From H.T. & L.T. installations to complete electrification solutions — Nataraj Electricals delivers ISO-certified quality across industrial, commercial, and public-sector projects.
                </p>
                <div className="mt-6 flex flex-wrap gap-3">
                  <Link to="/services" className="btn-white !py-2.5 !px-5 !text-xs sm:!text-sm">
                    Explore Services
                    <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2"><path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7"/></svg>
                  </Link>
                  <a href="tel:+919876543210" className="inline-flex items-center gap-2 rounded-md border border-background/30 bg-background/10 px-5 py-2.5 text-xs font-semibold text-background backdrop-blur-sm transition-colors hover:bg-background/20 sm:text-sm">
            ...
            <SectionReveal delay={0.15}>
              <div className="grid grid-cols-2 gap-3 sm:gap-4">
                {[
                  { value: "ISO 9001:2015", label: "Certified Quality", icon: <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg> },
                  { value: "Class-I", label: "Govt. License", icon: <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg> },
                  { value: "15+", label: "Years Experience", icon: <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z"/></svg> },
                  { value: "500+", label: "Projects Done", icon: <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m0 0l.5 1.5m-.5-1.5h-9.5m0 0l-.5 1.5"/></svg> },
                ].map((card) => (
                  <div key={card.label} className="flex flex-col items-start gap-2.5 rounded-xl border border-background/15 bg-background/10 p-4 backdrop-blur-sm transition-colors hover:bg-background/15 sm:p-5">
                    <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-background/20 text-background sm:h-10 sm:w-10">
                      {card.icon}
                    </div>
                    <div>
                      <div className="font-heading text-lg font-extrabold text-background sm:text-xl">{card.value}</div>
                      <div className="mt-0.5 text-[11px] font-medium text-background/70 sm:text-xs">{card.label}</div>
                    </div>
                  </div>
                ))}
              </div>
